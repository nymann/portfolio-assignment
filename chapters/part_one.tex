...
\centering
\includegraphics[scale=0.8]{part_1/components}
\end{figure}

\begin{figure}
\caption{Sensor layer class diagram}
\centering
\includegraphics[width=1\textwidth]{part_1/sensor}
\end{figure}

\begin{figure}
\caption{Commands package in the domain layer}
\centering
\includegraphics[width=1\textwidth]{part_1/domain-commands}
\end{figure}

\begin{figure}
\caption{Sensors package in the domain layer}
\centering
\includegraphics[width=1\textwidth]{part_1/domain-sensors}
\end{figure}

\begin{figure}
\caption{Exceptions package in the domain layer }
\centering
\includegraphics[width=0.4\textwidth]{part_1/domain-exceptions}
\end{figure}

\begin{figure}
\caption{Presentation layer class diagram}
\centering
\includegraphics[width=1\textwidth]{part_1/presentation}
\end{figure}
